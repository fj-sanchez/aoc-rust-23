...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `95.8µs` | `2.1ms` |
| [Day 2](./src/bin/02.rs) | `26.5ms` | `25.9ms` |
| [Day 3](./src/bin/03.rs) | `1.1ms` | `19.6ms` |
| [Day 4](./src/bin/04.rs) | `341.9µs` | `399.3µs` |
| [Day 6](./src/bin/06.rs) | `322.0ns` | `702.0ns` |
| [Day 7](./src/bin/07.rs) | `6.2ms` | `6.9ms` |
